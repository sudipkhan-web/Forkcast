      ...
      <div className="p-6 h-[35%] flex flex-col justify-start bg-stone-900 pointer-events-none">
        ...
        {(meal.calories != null || meal.carbsGrams != null || meal.proteinGrams != null || meal.fatGrams != null) && (
          <div className="flex items-center gap-2 mb-1.5 shrink-0">
            {[
              meal.calories != null ? { key: 'cal', val: String(meal.calories), unit: 'cal' } : null,
              meal.carbsGrams != null ? { key: 'carbs', val: `${meal.carbsGrams}g`, unit: 'C' } : null,
              meal.proteinGrams != null ? { key: 'protein', val: `${meal.proteinGrams}g`, unit: 'P' } : null,
              meal.fatGrams != null ? { key: 'fat', val: `${meal.fatGrams}g`, unit: 'F' } : null,
            ]
              .filter((m): m is { key: string; val: string; unit: string } => Boolean(m))
              .map((m, idx, arr) => (
